      ...
      <section className="flex relative flex-col justify-center items-center w-full h-full px-5 py-28 bg-black text-white">
        ...
        <div className="flex flex-col items-center px-8 py-12 bg-white bg-opacity-50 rounded-lg w-full max-w-md relative z-10">
          <form className="flex flex-col items-center w-full" onSubmit={handleSubmit}>
            <h1 className="text-4xl text-center mb-8">Sign Up Form</h1>
            <input
              id="username"
              type="text"
              aria-label="Username"
            ...
            <div className="relative w-full mt-4">
              <input
                ...
                onChange={handleInputChange}
                className="px-4 py-3 text-xl rounded-lg bg-gray-200 text-black placeholder-black placeholder-opacity-50 w-full pr-12"
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 flex items-center px-4 py-3"
              >
