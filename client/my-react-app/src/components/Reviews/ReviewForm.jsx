        ...
        <Form className="flex flex-col w-11/12 max-w-lg mx-auto">
          <div className="flex flex-col gap-4 text-sm text-black max-md:mt-4">
            ...
            <Field
              ...
              name="title"
              type="text"
              className="px-4 py-2 rounded-md bg-zinc-100 text-black text-sm max-md:px-3 max-md:py-1"
              placeholder="Title"
            />
          ...
          <button
            type="submit"
            className="mt-4 px-6 py-2 text-lg text-white bg-orange-500 rounded-md hover:bg-orange-600"
          >
            Submit Review
          </button>
        </Form>
